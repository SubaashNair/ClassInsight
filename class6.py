...
# Preset number of students
num_students = 30  # You can change this to the number of students in your class
...
if st.button("Submit"):
    if len(st.session_state.class_data) < num_students:
        ...
        st.warning("All student inputs have been collected.")
